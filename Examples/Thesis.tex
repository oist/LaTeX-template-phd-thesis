...
\usepackage{times} % For Times New Roman (deprecated but retains maths font)
\usepackage{helvet} % For Helvetica (equivalent)

% Force table font to be 10pt and sans serif
\makeatletter
...
\puttitle{
	title={Contribution to Entanglement Theory, Applications in Atomic Systems and Cavity QED}, % Title of the thesis
